...
{
    // Reference to the audio source for playing the sphere change sound
    public AudioSource sphereChangeAudioSource;
    ...
    {
        // Play the sphere change sound
                sphereChangeAudioSource.clip = clip1;
                sphereChangeAudioSource.Play();
    }
}
